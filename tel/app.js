var list = new Vue({
    ...
    data: {
        ...
        open_dial: false,
        tel_book: [
            {tel:"0922456789",name:"小明"},
            {tel:"0912569777",name:"小芳"},
            {tel:"0255440033",name:"小花"},
            {tel:"0800000000",name:"小本"},
            {tel:"0800000000",name:"小安"},
            {tel:"0800000000",name:"小山"},
            {tel:"0800000000",name:"小物"},
            {tel:"0800000000",name:"小七"},
            {tel:"0920000789",name:"小喜"}
        ],
        telB_false: true
    },
    computed: {
